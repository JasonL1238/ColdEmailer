...
400 tests. `conftest.py` points `COLD_DB_PATH` at a throwaway database and stubs
...
53 tests over the API client's request shapes and the screens where a wrong
